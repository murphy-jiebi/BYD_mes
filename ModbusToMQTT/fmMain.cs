    ...
    public partial class fmMain : Form
    {
        public fmMain()
        {
            ...
            try
            {
                ...
                txtSubTopic.Text = gIni.ReadString("MQTTParams", "MQTTSubTopic", "");
                gMQTTSubTopic = gIni.ReadString("MQTTParams", "MQTTSubTopic", "");
                txtPubTopic.Text = gIni.ReadString("MQTTParams", "MQTTPubTopic", "");
                gMQTTPubTopic = gIni.ReadString("MQTTParams", "MQTTPubTopic", "");
                txtPubTime.Text = gIni.ReadString("MQTTParams", "MQTTPubTime", "");
                ...
                txtModbusSvrPort.Text = gIni.ReadString("ModbusTCPParams", "ModbusSvrPort", "");
                gModbusSvrPort = ushort.Parse(gIni.ReadString("ModbusTCPParams", "ModbusSvrPort", ""));
                txtSlaveID.Text = gIni.ReadString("ModbusTCPParams", "SlaveID", "");
        ...
        string gMQTTPwd = "WF123456";
        string gMQTTSubTopic = "";
        string gMQTTPubTopic = "";
        int gMQTTPubTime = 5;
        ...
        int gModbusCmd = 3;
        int gModbusStartAdd = 0;
        int gModbusReadCount = 10;
        ...
        private void btnCommParamsSet1_Click(object sender, EventArgs e)
        {
            ...
            gIni.WriteString("MQTTParams", "MQTTSubTopic", txtSubTopic.Text.Trim());
            gIni.WriteString("MQTTParams", "MQTTPubTopic", txtPubTopic.Text.Trim());
            gIni.WriteString("MQTTParams", "MQTTPubTime", txtPubTime.Text.Trim());

            gIni.WriteString("ModbusTCPParams", "ModbusSvrIP", txtModbusSvrIP.Text.Trim());
            gIni.WriteString("ModbusTCPParams", "ModbusSvrPort", txtModbusSvrPort.Text.Trim());
            gIni.WriteString("ModbusTCPParams", "SlaveID", txtSlaveID.Text.Trim());
        ...
        private Task _mqttClient_ConnectedAsync(MqttClientConnectedEventArgs arg)
        {
            ...
            mqttClient.SubscribeAsync(gMQTTSubTopic, MqttQualityOfServiceLevel.AtLeastOnce);
